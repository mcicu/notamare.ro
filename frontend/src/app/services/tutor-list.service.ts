...
export class TutorListService {
  ...
  private tutors: Tutor[] = [
    ...
    new Tutor('Ana T.', 'https://icons-for-free.com/iconfiles/png/512/github+network+share+social+square+icon-1320086086636119316.png',['Mathematics'], 100, 'Teaching Mathematics'),
    new Tutor('Mihai C.', 'https://icons-for-free.com/iconfiles/png/512/github+network+share+social+square+icon-1320086086636119316.png',['Computer Science'], 75, 'Teaching computer science'),
  ];
